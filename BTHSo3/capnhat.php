<?php
    ...
    while ($row = mysqli_fetch_assoc($pbResult)) {
        echo "<tr style='text-align: center;'>
                ...
                <td>
                    <a href='xuli_capnhat.php?idpb=" . urlencode($row['IDPB']) . "' style='display:inline-block; padding:6px 12px; background:#f0ad4e; color:#fff; text-decoration:none; border-radius:4px;'>Sửa</a>
                </td>
              </tr>";
    }
    echo "</table>";
